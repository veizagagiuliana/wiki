<template lang='pug'>
  v-app-bar.nav-header(color='green', dark, app, :clipped-left='!$vuetify.rtl', :clipped-right='$vuetify.rtl', fixed, flat, :extended='searchIsShown && $vuetify.breakpoint.smAndDown')
    ...
    v-layout(row)
      v-flex(xs5, md4)
        v-toolbar.nav-header-inner(color='black', dark, flat, :class='$vuetify.rtl ? `pr-3` : `pl-3`')
          v-avatar(size='56' @click="goHome" style="border-radius: 8px; overflow: hidden; width: 127px !important")
            v-img.org-logo(:src="logoUrl" style="max-width: 100%; max-height: 100%;")
